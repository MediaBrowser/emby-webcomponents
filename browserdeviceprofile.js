        ...
        return Promise.all([
            ...
            getDecodingInfo({
                ...
                audio: {
                    ...
                    bitrate: 192000, // number of bits used to encode a second of audio
            ...
            if (canPlayMkv && !browser.tizen && !browser.orsay && options.enableMkvProgressive) {
                profile.TranscodingProfiles.push({
                    Container: 'mkv',
                    Type: 'Video',
                    AudioCodec: videoAudioCodecs.join(','),
