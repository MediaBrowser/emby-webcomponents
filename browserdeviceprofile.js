define(['browser'], function (browser) {
    ...
    function getGlobalMaxVideoBitrate() {
        ...
        return browser.ps4 ? 8000000 :
            (browser.xboxOne && !browser.edgeUwp ? 12000000 :
    ...
    return function (options) {
        ...
        var supportsVttInHls = options.enableVttInHls && (browser.edge || canPlayHlsWithMSE()) && !browser.edge  && !browser.web0s && !browser.chromecast && !browser.tizen && !browser.orsay && !browser.operaTv;
